// Script notes v2 — quote-driven structure
// Mapped to slides-v0.3.html (0-indexed)
const SCRIPT_NOTES = [
  // Slide 0: Title
  ``,

  // Slide 1: Dark visual — Opening hook (Herford scene)
...
You'd probably say, "That's ridiculous."`,
  ...
  // Slide 2: Dark visual — Herford 1949
...
His name was Bruno Gröning.`,
  ...
  // Slide 3: QUOTE 1 — "No human being can heal..."
  `At the center of Bruno Gröning's message was a surprising claim. He insisted that he himself was not the healer.
...
He was not building a personality cult. He was pointing away from himself — toward something much larger.`,
  ...
  // Slide 4: Dark visual — transition to healing
  `People did not come to Bruno Gröning just for ideas. They came because he spoke into pain, sickness, and hopelessness.
...
And in the middle of this, a man appears — with a message that sounds almost too simple.`,
  ...
  `"Trust and believe" — this was his central healing formula.
...
And then — receive. Not through effort or willpower, but through openness. Through a kind of inner stillness that allows something to flow in.`,
  ...
  // Slide 7: QUOTE 3 — "There is no incurable."
  `This is one of his most provocative claims. In his view, "incurable" was a human medical judgment — not a limit on divine power.
...
For him, a human being was not just sick or healthy. A human being was always choosing what power to receive.`,
  ...
  // Slide 14: Black — personal reflection begins
...
But for years, I've also been drawn to a different kind of question. The question of what the human being actually is. Whether there's more to us than what fits in a materialist framework.`,
  ...
  // Slide 15: Black — emotional center
