...
The message of Bruno Gröning.`,
  ...
  {
    slug: 'opening',
    text: `Imagine you're sick. You've been sick for a long time. You've tried everything — doctors, treatments, advice. Nothing worked.
...
You'd probably say, "That's ridiculous."`,
  ...
  {
    slug: 'herford',
    text: `But in 1949, in a small town in northern Germany called Herford, thousands of people showed up to hear exactly that. Thousands.
...
He wasn't building a personality cult. He was pointing away from himself — toward something much larger.`,
  ...
  {
    slug: 'ruins',
    text: `People didn't come to Bruno Gröning just for ideas. They came because he spoke into pain, sickness, and hopelessness.
...
And these are not just stories — the community that carries on his work documents such reports through a medical-scientific review process.`,
  ...
  {
    slug: 'mystery',
    text: `This line is important because it shows his perspective on skepticism
...
The kingdom within. Living water. Grace as a gift from God, not as a consumable commodity. The pattern is the same.`,
  ...
  {
    slug: 'thoughts',
    text: `This is crucial to understanding him. Thoughts, for Gröning, are not just mental events. They are forces.
